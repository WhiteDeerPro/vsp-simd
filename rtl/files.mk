...
RTL_CLUSTER_ROUTE_WAVE_PIPELINE := \
		rtl/cluster/vsp_cluster_route_wave_pipeline.sv
...
RTL_VSP_CONTROL_UWORD_DECODER := rtl/control/vsp_control_uword_decoder.sv
RTL_VSP_UWORD_ACTION_ADAPTER := rtl/control/vsp_uword_action_adapter.sv
RTL_VSP_MEMORY_UWORD_DECODER := rtl/control/vsp_memory_uword_decoder.sv
...
RTL_VSP_ROUTE_RENDEZVOUS_TABLE := \
		rtl/control/vsp_route_rendezvous_table.sv
RTL_VSP_ROUTE_WAVE_CONTROLLER := \
		rtl/control/vsp_route_wave_controller.sv
...
VSP_UWORD_PROGRAM_SOURCE_RTL := $(RTL_VSP_ACTION_PKG) \
		$(RTL_VSP_EXEC_UWORD_PKG) $(RTL_VSP_UWORD_PKG) \
		$(RTL_VSP_UWORD_PROGRAM_SOURCE)
...
VSP_MEMORY_UWORD_DECODER_RTL := $(RTL_VSP_PKG) \
		$(RTL_VSP_ACTION_PKG) $(RTL_VSP_EXEC_UWORD_PKG) \
		$(RTL_VSP_UWORD_PKG) $(RTL_VSP_MEMORY_UWORD_DECODER)
VSP_CONTROL_UWORD_DECODER_RTL := $(RTL_VSP_ACTION_PKG) \
		$(RTL_VSP_EXEC_UWORD_PKG) $(RTL_VSP_UWORD_PKG) \
		$(RTL_VSP_SEQUENCER_STATE_PKG) \
		$(RTL_VSP_CONTROL_UWORD_DECODER)
VSP_UWORD_ACTION_ADAPTER_RTL := $(RTL_VSP_PKG) \
		$(VSP_CONTROL_UWORD_DECODER_RTL) \
		$(RTL_VSP_MEMORY_UWORD_DECODER) \
		$(RTL_VSP_UWORD_ACTION_ADAPTER)
VSP_ORDERED_ACTION_WINDOW_RTL := $(RTL_VSP_ACTION_PKG) \
		$(RTL_VSP_ORDERED_ACTION_WINDOW)
VSP_ROUTE_RENDEZVOUS_RTL := $(RTL_VSP_EXEC_UWORD_PKG) \
		$(RTL_VSP_ROUTE_RENDEZVOUS_TABLE)
VSP_ROUTE_WAVE_CONTROLLER_RTL := $(VSP_ROUTE_RENDEZVOUS_RTL) \
		$(RTL_VSP_ROUTE_WAVE_CONTROLLER)
...
CLUSTER_ROUTE_WAVE_PIPELINE_RTL := $(VSP_ROUTE_WAVE_CONTROLLER_RTL) \
