...
collector、GROUP_EXEC exec shell、VRF span engine、row exchange engine、issue queue 与
frontend 都已纳入现有 `lint/test` 聚合入口，没有为该分类另建顶层脚本。
