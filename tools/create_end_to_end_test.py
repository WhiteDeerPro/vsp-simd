...
process_center_region:
    ...
    # 创建左移版本（通过slide）
    EXEC_ROUTE op=slide_down va=0 vd=3 amount=1
    EXEC_ROUTE op=slide_down va=1 vd=4 amount=1
    EXEC_ROUTE op=slide_down va=2 vd=5 amount=1

    # 创建右移版本
    EXEC_ROUTE op=slide_up va=0 vd=6 amount=1
    EXEC_ROUTE op=slide_up va=1 vd=7 amount=1
    EXEC_ROUTE op=slide_up va=2 vd=8 amount=1
